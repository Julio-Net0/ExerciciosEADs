...
def is_pair(openingBracket, closingBracket):
    diff = ord(closingBracket) - ord(openingBracket)

    return (diff == 1 or diff == 2) and openingBracket in "({["
